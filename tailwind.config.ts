  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'typing-dot':       'typing-dot 1.1s var(--ease-in-out) infinite',
        'fade-in':          'fade-in var(--dur-slow,320ms) var(--ease-out) forwards',
        'slide-in':         'slide-in var(--dur-slow,320ms) var(--ease-out) forwards',
        'pop-in':           'pop-in 0.4s var(--ease-overshoot) forwards',
        'float-up':         'float-up 1s ease-out forwards',
        'slide-up':         'slide-up 0.38s var(--ease-overshoot) forwards',
        'bounce-in':        'bounce-in 0.5s var(--ease-overshoot) forwards',
        'wiggle':           'wiggle 0.5s ease-in-out',
        'wiggle-loop':      'wiggle 0.6s ease-in-out infinite',
        'glow-pulse':       'glow-pulse 2s ease-in-out infinite',
        'heartbeat':        'heartbeat 1.2s ease-in-out infinite',
        'shake':            'shake 0.38s ease-in-out',
        'counter-up':       'counter-up var(--dur-base,220ms) var(--ease-overshoot) forwards',
        'correct-flash':    'correct-flash var(--dur-deliberate,450ms) var(--ease-out) forwards',
        'card-enter':       'card-enter 0.36s var(--ease-out) forwards',
